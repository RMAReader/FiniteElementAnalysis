...
void toolpath_TrimBlocksEndBouts::calculate()
{
	...
	trim_end_block(c["rib_internal_lower_bout"], c["centre_line"], c["block_bottom"], block_top_z, block_bottom_z, step_z, resolution);
	...
	trim_end_block(c["rib_internal_upper_bout"], c["centre_line"], c["block_neck"], block_top_z, block_bottom_z, step_z, resolution);
